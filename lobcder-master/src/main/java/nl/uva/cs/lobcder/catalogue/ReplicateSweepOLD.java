...
//                    }
                ...
                for (PDRIDescr sourceDescr : toReplicate) {
                    ...
                    try (PreparedStatement preparedStatement = connection.prepareStatement("INSERT INTO pdri_table "
                        ...
                        if (loclPrefStr != null && loclPrefStr.length() > 1) {
                            ...
                            if (destinationSite != null) {
                                ...
                                try {
                                    ...
                                    failed = true;
                                    Logger.getLogger(ReplicateSweepOLD.class.getName()).log(Level.WARNING, null, ex);
                                }
                                if (!failed) {
                        ...
                        Logger.getLogger(ReplicateSweepOLD.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            } catch (SQLException | IOException e) {
                ReplicateSweepOLD.log.log(Level.SEVERE, null, e);
                connection.rollback();
            }
