...
public class Constants {
    ...
    public static final QName ENCRYPTED_PROP_NAME = new QName("custom:", "encrypted");
    ...
    public static final QName[] PROP_NAMES = new QName[]{DATA_DIST_PROP_NAME, DRI_SUPERVISED_PROP_NAME, DRI_CHECKSUM_PROP_NAME, DRI_LAST_VALIDATION_DATE_PROP_NAME,DESCRIPTION_PROP_NAME,DATA_LOC_PREF_NAME,ENCRYPTED_PROP_NAME};
