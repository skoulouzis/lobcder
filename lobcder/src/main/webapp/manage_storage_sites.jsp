...
//                var r = new Y.Resource({ uri: 'rest/storage_sites/set' });
 
                //                r.GET({	// makes request to: path/to/resource/?format=json
                //                    params	: { id: 'all' },
                //                    on	: {
                //                        success : function(e){
                //                            // e.entity is an Object parsed from the JSON returned by the server
                //                            Y.log(e.response.response);
                //                        }
                //                    }
                //                });
