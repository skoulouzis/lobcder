...
public class Base64
{
	 ...
	 * four-byte array in Base64 notation. The actual number of significant bytes in your array
	 * is given by <var>numSigBytes</var>. The array <var>threeBytes</var> needs only be as big
	 * as <var>numSigBytes</var>. Code can reuse a byte array by passing a four-byte array as
	 * <var>b4</var>.
	 * 
	 * @param b4
	 ...
	 * Base64 bytes to <var>destination</var>. The source and destination arrays can be
	...
	/**
	 * Serializes an object and returns the Base64-encoded version of that serialized object. If
	 * the object cannot be serialized or there is another error, the method will return
	 ...
	 * <var>destOffset</var> + 3 for the <var>destination</var> array. This method returns the
